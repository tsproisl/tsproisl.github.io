...
do
    ...
    LANG=en_US.UTF-8 pandoc -f markdown -t html5 --template template.html5 --citeproc --standalone --include-before-body "$BEFORE_BODY" --include-after-body "$AFTER_BODY" --css proisl.css -o ../"$name".html "$f"
done
